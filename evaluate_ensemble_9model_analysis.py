...
def main():
    ...
    with open(os.path.join(DATA_DIR, "ensemble_report_9model_ANALYSIS.txt"), "w", encoding="utf-8") as f:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(DATA_DIR, "ensemble_confusion_matrix_9model_ANALYSIS.png"), dpi=150)
    plt.close()

    with open(os.path.join(DATA_DIR, "ensemble_config_9model_ANALYSIS.pkl"), "wb") as f:
        pickle.dump({
